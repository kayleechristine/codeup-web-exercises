...
//     if (input === "green") {
//         console.log("Green like the trees and the grass!");
//     } else if (input === "yellow") {
//         console.log("Yellow is the color of the sun.");
//     } else if (input === "blue") {
//         console.log("Blue is the color of the ocean waves.");
//     } else {
//         console.log("There's probably a " + input + " flower out there somewhere.");
//     }
//     return input
// }
...
function analyzeColor(input) {
    switch (input) {
        case "yellow":
            ...
            // break;
        case "green":
            return "Green like the grass and the trees!";
            // break;
        case "blue":
            return "Blue like the ocean waves.";
            // break;
        default:
            return "There's probably a " + input + " flower out there somewhere.";
            // break;
    }
}
